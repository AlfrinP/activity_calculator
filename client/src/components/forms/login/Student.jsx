...
import { validateRegisterNo } from "../../Util";

function Student({ onSubmitdata }) {
  ...
  const onSubmit = (data) => {
    ...
    const registerNo = data.regno;
    const validationResults = validateRegisterNo(registerNo);
    ...
    const formDataWithValidation = {
      ...data,
      batch: validationResults.batch,
      department: validationResults.department,
    };
    onSubmitdata(formDataWithValidation);
    console.log(formDataWithValidation);
  };
