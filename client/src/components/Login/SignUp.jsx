...
import { baseURL, validateRegisterNo } from "../Util";
...
function SignUp() {
  ...
  const setRegNoData = (e) => {
    setBatch(validateRegisterNo(e).batch);
    setDepartment(validateRegisterNo(e).department);
    setRegno(validateRegisterNo(e).regNo);
  };
    ...
    <div className="w-full h-screen background-main center flex">
      <div className="lg:w-1/2 h-full w-full center py-10 px-15 lg:center">
        <div className="w-full h-screen center">
          <form
            className="relative lg:h-3/4 h-[90%] gap-3 py-5 flex flex-col  justify-evenly background-form text-white  w-96 rounded-xl bg-clip-border"
