          ...
          {data?.map((item, index) => (
            <tr key={index} className={index % 2 === 0 ? "even:bg-[#F7F6FE]" : "odd:bg-white"}>
              ...
              <td className="px-5 py-2 center">
                <span className={`flex shrink-0 items-center space-x-1.5 text-xs font-medium px-3 py-1 rounded-full ${approvalState[item.status]}`}>
              ...
              <td className="px-5 py-2 text-center text-[#512B81] hover:underline cursor-pointer">
                <a onClick={() => handleOpenViewCertificate(item)} href="#">
                  View
                </a>
              </td>
            </tr>
